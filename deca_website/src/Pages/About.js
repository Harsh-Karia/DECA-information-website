...
export default function About(){
	return(
		<div className="aboutpage">
			<Container>
				<h1>About Page</h1>
				<h2>DECA stands for Distributive Education Clubs of America, an association that encourages the development of business and leadership skills through academic conferences and competitions.
			It is an organization that prepares emerging leaders and entrepreneurs for careers in Marketing, Finance, Hospitality, and Management worldwide.
				</h2>
			</Container>
			<Container>
				<div className="box">
					...
					<div className="card">
						<h2 classname="normal">What the club does</h2>
